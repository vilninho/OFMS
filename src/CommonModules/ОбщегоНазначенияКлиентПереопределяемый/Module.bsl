...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	// rarus tenkam 27.03.2019 mantis 14275 +++
	ДопПараметры = Неопределено;
	//Scan_ОбщегоНазначения.ИнициализироватьПраваИНастройки();	
	
	Scan_ОбщегоНазначения.Scan_ИнициализацияСеансаСервер(ДопПараметры);
	Scan_ОбщегоНазначенияКлиент.Scan_ИнициализацияСеансаКлиент(ДопПараметры);
	// rarus tenkam 27.03.2019 mantis 14275 ---	
