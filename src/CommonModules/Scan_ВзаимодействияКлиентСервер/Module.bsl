...
Функция ЯвляетсяВзаимодействием(ОбъектСсылка) Экспорт
	...
	//ТипЗнч(ОбъектСсылка) = Тип("ДокументСсылка.Встреча")
	...
	ТипЗнч(ОбъектСсылка) = Тип("ДокументСсылка.Событие")
...
Функция ЯвляетсяПрисоединеннымФайломВзаимодействий(ОбъектСсылка) Экспорт
	...
	Возврат 
		//+Рарус Документы убраны из взаимодейстивий
		//ТипЗнч(ОбъектСсылка) = Тип("СправочникСсылка.ВстречаПрисоединенныеФайлы")
		...
		ТипЗнч(ОбъектСсылка) = Тип("СправочникСсылка.СобытиеПрисоединенныеФайлы")
		//-Рарус
...
Процедура ПриИзмененииОтбораТипВзаимодействий(Форма,ТипВзаимодействия) Экспорт
	...
	//	
	ИначеЕсли ТипВзаимодействия = "Событие" Тогда
		
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора, 
			"Тип", Тип("ДокументСсылка.Событие"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
		
			
			
	ИначеЕсли ТипВзаимодействия = "Анкетирование" Тогда
		
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора,
			"Тип", Тип("ДокументСсылка.Событие"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора, 
			"ХозОперация",ПредопределенноеЗначение("Справочник.ХозОперации.Анкетирование"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
		
	ИначеЕсли ТипВзаимодействия = "ЛичнаяВстреча" Тогда
		
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора,
			"Тип", Тип("ДокументСсылка.Событие"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора, 
			"ХозОперация",ПредопределенноеЗначение("Справочник.ХозОперации.ЛичнаяВстреча"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
			
	ИначеЕсли ТипВзаимодействия = "ПочтовоеПисьмо" Тогда
		
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора,
			"Тип", Тип("ДокументСсылка.Событие"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора, 
			"ХозОперация",ПредопределенноеЗначение("Справочник.ХозОперации.ПочтовоеПисьмо"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
		
	ИначеЕсли ТипВзаимодействия = "ЭлектронноеПисьмо" Тогда
		
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора,
			"Тип", Тип("ДокументСсылка.Событие"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора, 
			"ХозОперация",ПредопределенноеЗначение("Справочник.ХозОперации.ЭлектронноеПисьмо"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
			
	ИначеЕсли ТипВзаимодействия = "СообщениеSMS" Тогда
		
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора,
			"Тип", Тип("ДокументСсылка.Событие"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора, 
			"ХозОперация",ПредопределенноеЗначение("Справочник.ХозОперации.СообщениеSMS"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
			
	ИначеЕсли ТипВзаимодействия = "ТелефонныйЗвонок" Тогда
		
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора,
			"Тип", Тип("ДокументСсылка.Событие"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(ГруппаОтбора, 
			"ХозОперация",ПредопределенноеЗначение("Справочник.ХозОперации.ТелефонныйЗвонок"),ВидСравненияКомпоновкиДанных.Равно,, Истина);
			
	ИначеЕсли ТипВзаимодействия = "ИсходящееSMS" Тогда
	//-Рарус
...
Функция ПолучитьПредставлениеАдресата(Имя, Адрес, Контакт) Экспорт
	...
	Результат = ?(Имя = Адрес ИЛИ Имя = "", Адрес,?(ПустаяСтрока(Адрес),Имя, ?(Найти(Имя, Адрес) > 0, Имя, Имя + " <" + Адрес + ">")));
...
Функция КонтактыЗаполнены(ВзаимодействиеОбъект,ВидДокумента)
	...
	//	
	ИначеЕсли ВидДокумента = "Событие" Тогда
		
		Если НЕ ЗначениеЗаполнено(ВзаимодействиеОбъект.Контрагент) Тогда
			Возврат Ложь;
		КонецЕсли;
	//-Рарус
...
Функция СтатусПоИмениКоманды(ИмяКоманды) Экспорт
	...
	НайденнаяПозиция = Найти(ИмяКоманды, "_");
...
//+Рарус Принято решения что прочия взаимодействия могут использоваться независмо от почтового клиента
Функция ТипВзаимодействияПоИмениКоманды(ИмяКоманды, ТолькоПочта, ТолькоПрочиеВзаимодействия) Экспорт
//-Рарус
	НайденнаяПозиция = Найти(ИмяКоманды, "_");
	Если НайденнаяПозиция = 0 Тогда
		Возврат "Все";
	...
	//+Рарус Принято решения что прочия взаимодействия могут использоваться независмо от почтового клиента
	Если СписокОтборовПоТипуВзаимодействий(ТолькоПочта,ТолькоПрочиеВзаимодействия).НайтиПоЗначению(СтрокаТипВзаимодействия) = Неопределено Тогда
	//-Рарус
		Возврат "Все";
	КонецЕсли;
...
// +Рарус Принято решение что прочие документы взаимодействий могут работать без включенного Почтового клиента
Функция СписокОтборовПоТипуВзаимодействий(ИспользуетсяПочтовыйКлиент,ИспользуютсяПрочиеВзаимодействия) Экспорт
// -Рарус
	СписокОтборов = Новый СписокЗначений;
	
	//+Рарус Добавлены картинки
	СписокОтборов.Добавить("Все", НСтр("ru = 'Все'"),,БиблиотекаКартинок.ВсеВзаимодействия);
	//+Рарус Принято решение что прочие документы взаимодействий могут работать без включенного Почтового клиента
	Если ИспользуетсяПочтовыйКлиент Тогда
		СписокОтборов.Добавить("ВсеПисьма", НСтр("ru = 'Все письма'"),,БиблиотекаКартинок.ЭлектронноеПисьмо);
	КонецЕсли;
	Если ИспользуютсяПрочиеВзаимодействия Тогда
		//+Рарус Документы удалены из взимодействий
		...
		СписокОтборов.Добавить("ИсходящееSMS", НСтр("ru = 'Исходящее SMS'"),,БиблиотекаКартинок.ИсходящееSMS);
		//-Рарус
	КонецЕсли;
	
	СписокОтборов.Добавить("Событие", НСтр("ru = 'Событие'"),,БиблиотекаКартинок.Событие);
	
	Если ИспользуетсяПочтовыйКлиент Тогда
		СписокОтборов.Добавить("ВходящиеПисьма", НСтр("ru = 'Входящие'"),,БиблиотекаКартинок.ВходящиеПисьма);
		СписокОтборов.Добавить("ПисьмаЧерновики", НСтр("ru = 'Черновики'"),,БиблиотекаКартинок.ПисьмаЧерновики);
		СписокОтборов.Добавить("ИсходящиеПисьма", НСтр("ru = 'Исходящие'"),,БиблиотекаКартинок.ИсходящиеПисьма);
		СписокОтборов.Добавить("Отправленные", НСтр("ru = 'Отправленные'"),,БиблиотекаКартинок.ОтправленныеПисьма);
		СписокОтборов.Добавить("УдаленныеПисьма", НСтр("ru = 'Удаленные'"),,БиблиотекаКартинок.УдаленныеПисьма);
	КонецЕсли;
	//+Рарус Документы удалены из взимодействий
		//	Если ИспользуютсяПрочиеВзаимодействия Тогда
	...
	СписокОтборов.Добавить("Анкетирование", НСтр("ru = 'Анкетирование'"),,БиблиотекаКартинок.Анектирование);
	СписокОтборов.Добавить("ЛичнаяВстреча", НСтр("ru = 'Личная встреча'"),,БиблиотекаКартинок.ЛичнаяВстреча);
	СписокОтборов.Добавить("ПочтовоеПисьмо", НСтр("ru = 'Почтовое письмо'"),,БиблиотекаКартинок.ПочтовоеПисьмо);
	СписокОтборов.Добавить("ЭлектронноеПисьмо", НСтр("ru = 'Электронное письмо'"),,БиблиотекаКартинок.ЭлектронноеПисьмоСобытие);
	СписокОтборов.Добавить("СообщенияSMS", НСтр("ru = 'Сообщения SMS'"),,БиблиотекаКартинок.СообщениеSMSСобытие);
	СписокОтборов.Добавить("ТелефонныйЗвонок", НСтр("ru = 'Телефонный звонок'"),,БиблиотекаКартинок.ТелефонныйЗвонокСобытие);
	//-Рарус
	//-Рарус
...
Процедура ОбработкаПолученияПредставления(МенеджерОбъекта, Данные, Представление, СтандартнаяОбработка) Экспорт
	...
	Если ТипЗнч(МенеджерОбъекта) = Тип("ДокументМенеджер.СообщениеSMS") Тогда
		ТипДокумента = НСтр("ru = 'Исходящее SMS'");
	ИначеЕсли ТипЗнч(МенеджерОбъекта) = Тип("ДокументМенеджер.Событие") Тогда
		ТипДокумента = НСтр("ru = '"+Данные.ХозОперация+"'");
	//-Рарус
...
Процедура ОбработкаПолученияПолейПредставления(МенеджерОбъекта, Поля, СтандартнаяОбработка) Экспорт
	...
	Поля.Добавить("Дата");
	//+Рарус
	Если ТипЗнч(МенеджерОбъекта) = Тип("ДокументМенеджер.Событие") Тогда
