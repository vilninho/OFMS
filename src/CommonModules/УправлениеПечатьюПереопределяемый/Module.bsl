...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.Scan_ЗаявкаНаДействие);
	//rarus tenkam 02.08.2016 
	
	//rarus FominskiyAS 26.02.2019  mantis 13863 +++
	СписокОбъектов.Добавить(Справочники.Scan_ДействияНаЗначимыеСобытия);
	СписокОбъектов.Добавить(Справочники.Scan_ЗначимыеСобытия);
	СписокОбъектов.Добавить(Справочники.Организации);
	СписокОбъектов.Добавить(Документы.Scan_ЗаявкаНаКомплектующие);
	СписокОбъектов.Добавить(Документы.Scan_ЗаявкаНаСервисныеРаботы);
	СписокОбъектов.Добавить(Документы.Scan_ЗаявкаПеревозчику);
	СписокОбъектов.Добавить(Документы.Scan_ПоступлениеКомплектующих);
	СписокОбъектов.Добавить(Документы.Scan_ЧекЛистТехническогоСостоянияИзделия);
	СписокОбъектов.Добавить(Документы.Scan_ЗакреплениеМенеджеровЗаДилерами);//rarus bonmak 07.01.2021 16625
	//rarus FominskiyAS 26.02.2019  mantis 13863 ---
