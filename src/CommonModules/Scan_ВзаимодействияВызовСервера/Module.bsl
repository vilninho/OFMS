...
//   - 
//
Функция ПолучитьНомерТелефонаКонтакта(Контакт) Экспорт
	...
	КонтактнаяИнформацияОбъекта = УправлениеКонтактнойИнформацией.
		КонтактнаяИнформацияОбъектов(МассивОбъектов,, Справочники.ВидыКонтактнойИнформации.ТелефонКонтрагента);
...
//                                           цепочки взаимодействий первым взаимодействием которых является взаимодействие входящее в массив.
//
