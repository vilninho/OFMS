...
Процедура ПриОпределенииВозможныхКонтактов(ТипыКонтактов) Экспорт
	...
	//rarus vikhle 13.10.2021 mt 17995 +++
	Контакт = ВзаимодействияКлиентСервер.НовоеОписаниеКонтакта();
	Контакт.Тип = Тип("СправочникСсылка.Scan_КонтактныеЛица");
	Контакт.Имя = "Scan_КонтактныеЛица";
	Контакт.Представление = НСтр("ru = 'Контактные лица'");
