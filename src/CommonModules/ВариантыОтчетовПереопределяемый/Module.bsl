...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(Метаданные.Подсистемы.Scan_НСИ,   НСтр("ru = 'Отчеты по НСИ'"));
	Разделы.Добавить(Метаданные.Подсистемы.Scan_ОтделКлиентскойПоддержки, НСтр("ru = 'Отчеты отдела администрирования'"));//rarus vikhle 18.06.2020 mt 15695 изменил имя подсистемы на актуальное
	Разделы.Добавить(Метаданные.Подсистемы.Scan_ОтделЛогистики, НСтр("ru = 'Отчеты отдела логистики'"));
	Разделы.Добавить(Метаданные.Подсистемы.Scan_ОтделПланирования, НСтр("ru = 'Отчеты отдела планирования'"));
	//Разделы.Добавить(Метаданные.Подсистемы.Администрирование, НСтр("ru = 'Отчеты администрирования'")); //rarus FominskiyAS 10.03.2019  mantis 13863 +
	//rarus tenkam 26.07.2016 mantis 7162 --
