...
Процедура ЗаписатьСтатистикуОткрытияФайла() // Rarus tenkam 11.04.2022 mantis 18433 +++
	Scan_СборСтатистики.ВыполнитьРегистрациюСтатистики("Обработки", Метаданные.Обработки.РаботаСФайлами.Синоним, "Открытие присоединенного файла"); 
...
Процедура ОткрытьФайл()
	...
	ЗаписатьСтатистикуОткрытияФайла() // Rarus tenkam 11.04.2022 mantis 18433 +
