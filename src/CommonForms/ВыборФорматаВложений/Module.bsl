...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.ТекущийЭлемент = ЭтаФорма.Элементы.КнопкаПрикрепить; //rarus sergei 26.01.2017 mantis 8357 +
	
	//rarus tenkam 28.04.2017 mantis 9444 +++
	Если Параметры.Свойство("ЭтоНастройка") Тогда	
		Элементы.ГруппаДополнительныеПараметры.Видимость = Ложь;
	КонецЕсли;
	//rarus tenkam 28.04.2017 mantis 9444 ---
